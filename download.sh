...
echo ""
read -p "Enter the target folder for downloading files (default is current directory): " TARGET_FOLDER
TARGET_FOLDER=${TARGET_FOLDER:-"."}  # Use current directory if no input
